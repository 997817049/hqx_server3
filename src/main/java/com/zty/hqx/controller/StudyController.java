...
// <--------------------------------------获取电视------------------------------------------>
    ...
    public Result<List<VideoModel>> getHotVideo(int userId, @IsVideoPart String part, int num, int limit) {
        EStudyPart epart = EStudyPart.getEnumFromString(part.toUpperCase());
    ...
    public Result<List<VideoModel>> getRecentVideo(int userId, @IsVideoPart String part, int num, int limit) {
        EStudyPart epart = EStudyPart.getEnumFromString(part.toUpperCase());
