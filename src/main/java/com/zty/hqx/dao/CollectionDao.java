...
import com.zty.hqx.model.CollectionModel;
...
public interface CollectionDao {
    ...
    List<CollectionModel> getCollectionsByNum(@Param("id") Integer id, @Param("num") Integer num, @Param("readNum") Integer OnceReadNum);

    @Select("SELECT * FROM user_collection_${id} ORDER BY id DESC LIMIT #{readNum}")
    List<CollectionModel> getCollectionsLimit(@Param("id") Integer id, @Param("readNum") Integer OnceReadNum);
    ...
    int tableIsExixt(@Param("id") Integer id);
    ...
    boolean buildTable(@Param("id") Integer id);
